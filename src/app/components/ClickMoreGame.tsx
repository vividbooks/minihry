...
export function ClickMoreGame({ settings, onGameComplete }: ClickMoreGameProps) {
  ...
  useEffect(() => {
    if (clickedCount >= targetCount && isGameActive) {
      handleGameEnd(true, `Skvělé! Naklikal jsi ${clickedCount} objektů!`);
    }
    ...
    >
      ...
      <div className="absolute top-16 left-1/2 transform -translate-x-1/2 z-10">
        <div className="bg-green-500 text-white px-6 py-3 rounded-full shadow-lg">
          <h1 className="text-xl font-bold">Naklikej více objektů!</h1>
        </div>
      </div>
      ...
      <div className="absolute top-32 left-1/2 transform -translate-x-1/2 z-10">
        <div className="bg-white/90 backdrop-blur-sm px-4 py-2 rounded-lg shadow-lg">
          <div className="text-center">
            ...
            <div className="text-sm text-gray-600">objektů</div>
          </div>
        </div>
      </div>
